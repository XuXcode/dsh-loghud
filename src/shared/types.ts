export type ErrorCategory =
  ...
  | 'TYPESCRIPT_COMPILE' | 'MODULE_RESOLUTION' | 'BUILD_FAILURE' | 'UNKNOWN'
...
export type RuntimeLanguage = 'java' | 'javascript' | 'typescript' | 'unknown'
export type RuntimeName = 'jvm' | 'node' | 'unknown'
export type Toolchain = 'maven' | 'gradle' | 'java' | 'node' | 'npm' | 'pnpm' | 'yarn' | 'typescript' | 'vite' | 'rollup' | 'webpack' | 'next' | 'vitest' | 'jest' | 'unknown'
