...
const snapshot: SessionSnapshot = { sessionId: 's1', health: 'BROKEN', observedCommand: true, active: [error], resolved: [], revision: 1 }
...
describe('client HUD', () => {
  ...
  it('uses Chinese browser copy and Harness theme variables', async () => {
    ...
    expect(host.innerHTML).toContain('var(--color-bg-elevated')
